...
(gtk_accel_path "<Actions>/terminal-window/paste-selection" "<Primary><Shift>b")
...
; (gtk_accel_path "<Actions>/terminal-window/goto-tab-46" "")
; (gtk_accel_path "<Actions>/terminal-window/goto-tab-45" "")
